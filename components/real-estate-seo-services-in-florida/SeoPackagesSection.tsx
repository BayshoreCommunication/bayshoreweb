...
const packageColumns: PackageColumn[] = [
  {
    key: "launch",
    title: "Agent Starter",
    subtitle: "For Individual Business",
    price: "$$",
  ...
  },
  {
    ...
    subtitle: "For Competitive Brokerages",
    price: "$$",
  ...
  },
  {
    ...
    subtitle: "For Brokerages & Developers Owner",
    price: "$$",
    cta: "Request Proposal",
  },
];
...
const featureRows: FeatureRow[] = [
  {
    ...
    values: {
      launch: [
        "Local SEO setup and GBP optimization",
        "On page optimization for up to 10 existing pages",
        "Local SEO setup and GBP optimization",
      ],
      scale: [
        "Full technical SEO audit and remediation",
        "Included",
        "Active GBP management and review strategy",
      ],
      dominate: [
        "Aggressive technical SEO with ongoing quarterly audits",
        "Included",
        "Included",
      ],
    },
  },
  {
    ...
    values: {
      launch: [
        "5 targeted neighborhood or location landing pages",
        "Not Included",
        "Not Included",
      ],
      scale: [
        "15 neighborhood and location content pages",
        "Not Included",
        "IDX page optimization",
      ],
      dominate: [
        "30+ neighborhood, location, and market report pages",
        "30+ neighborhood, location, and market report pages",
  ...
  },
  {
    ...
    values: {
      launch: [
        "Not Included",
        "Not Included",
        "Basic editorial link building",
      ],
      scale: [
        "AI Overview content structuring",
        "Not Included",
        "Mid tier editorial link acquisition",
      ],
      dominate: [
        "Full AI and GEO optimization (Google, ChatGPT, Perplexity)",
        "Full AI and GEO optimization (Google, ChatGPT, Perplexity)",
        "Premium editorial link building from Florida and national publications",
      ],
    },
  },
  {
    ...
    values: {
      ...
      scale: [
        "Monthly performance reporting with strategy notes",
        "Not Included",
        "Not Included",
      ],
      dominate: [
      ...
      <div className="mx-auto max-w-[1500px] px-4 md:px-8">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-4 max-w-[1180px] text-[32px] font-bold leading-[1.08] text-[#081B4B] md:text-[50px]">
            SEO Packages for Florida Real Estate Businesses
          </h2>

          <p className="mx-auto mt-4 max-w-[960px] text-[15px] leading-7 text-black/60 md:text-[18px]">
            Our affordable SEO packages for real estate businesses in FL are
            structured in three tiers. They built for where you are now and
        ...
        <p className="mx-auto mt-4 max-w-[980px] text-center text-[13px] leading-6 text-black/55">
          All packages are adjusted based on your Florida real estate market,
