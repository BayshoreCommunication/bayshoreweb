    ...
    <section className="relative isolate overflow-hidden bg-[#020B2D] text-white">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="SEO Services for Small Businesses in Florida"
          fill
          priority
        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1fr_430px] xl:gap-24">
          ...
          <div>
            ...
            <h1 className="mt-6 max-w-[720px] text-[38px] font-extrabold leading-[1.05] sm:text-[52px] md:text-[64px]">
              ...
              Small Businesses
              <br />
              in <span className="text-[#FF6F00]">Florida</span>
            </h1>

            <p className="mt-6 max-w-[700px] text-[16px] leading-[1.7] text-white/85 md:text-[18px]">
              <span className="font-semibold text-white">
                Get Found, Get Customers, Get Growing
              </span>
              <br />
              Don&apos;t you want visibility where 98% of Florida consumers
              search before they visit? Local small businesses remain invisible
              while competitors claim all the top Google search rankings.
              Bayshore Communication’s SEO services for small businesses in
              Florida help you rank higher on Google. Our SEO strategy turns
              your website into a sales tool that attracts local customers and
              grows your revenue.
            </p>
