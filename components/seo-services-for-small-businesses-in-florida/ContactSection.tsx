          ...
          <div className="pt-2 md:pt-12">
            <div className="mb-8 flex items-center gap-4 text-[#FF6F00]">
              ...
              <span className="font-bold uppercase text-[#FF6F00]">
                Contact Bayshore Communication
              </span>
            ...
            <p className="mt-8 max-w-[440px] text-[17px] leading-8 text-black/70 md:text-[19px]">
              Your competitors are already investing in SEO. Every day without
              it means lost rankings, missed calls and customers choosing
              someone else. Contact Bayshore Communication today to claim your
              free SEO audit. Let our SEO services for small businesses in
              Florida build a search presence that puts your company exactly
            ...
            <div className="mt-12 space-y-5">
              {[
                {
                  icon: TrendingUp,
                  text: "Lost rankings, missed calls and customers choosing someone else",
                },
                {
                  icon: MapPin,
                  text: "Claim your free SEO audit",
                },
                {
                  icon: Users,
                  text: "SEO services for small businesses in Florida",
                },
                {
                  icon: ShieldCheck,
                  text: "A search presence where your customers are looking",
                },
              ].map((item, index) => {
          ...
          <div className="self-start">
            ...
            <div className="grid gap-5 rounded-b-[16px] border border-t-0 border-black/5 bg-white px-6 py-5 shadow-[0_18px_35px_rgba(0,0,0,0.07)] md:grid-cols-3 md:px-8">
              <TrustItem
                ...
                text="Trusted by Florida Small Businesses"
              />
              ...
              <TrustItem
                icon={<MapPin size={22} />}
                text="Focused on Florida Search Visibility"
              />
            </div>
          </div>
        </div>
