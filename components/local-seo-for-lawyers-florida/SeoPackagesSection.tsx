...
const featureRows: FeatureRow[] = [
  {
    ...
    values: {
      launch: ["Included", "Included", "Included", "Included", "Included"],
      scale: ["Included", "Included", "Included", "Included", "Included"],
      dominate: ["Included", "Included", "Included", "Included", "Included"],
    },
  },
  {
    ...
    icon: Settings,
    items: [
      "Advanced Link Building & Citations",
      "Content Creation",
    ...
    values: {
      launch: ["Not Included", "Not Included", "Not Included", "Not Included", "Not Included"],
      scale: ["Included", "4 pages/mo", "Included", "Included", "Included"],
      dominate: ["Included", "4+ pages/mo", "Included", "Included", "Included"],
    },
  },
  {
    ...
    items: [
      ...
      "Multi-city & Multi-practice SEO",
      "Conversion Rate Optimization",
      "Dedicated Account Manager",
      "Custom Strategy & Weekly Reporting",
    ],
    values: {
      launch: ["Not Included", "Not Included", "Not Included", "Not Included", "Not Included"],
      scale: ["Not Included", "Not Included", "Not Included", "Not Included", "Not Included"],
      dominate: ["Included", "Included", "Included", "Included", "Included"],
    },
  },
  {
      ...
      <div className="mx-auto max-w-[1500px] px-4 md:px-8">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-4 max-w-[1180px] text-[32px] font-bold leading-[1.08] text-[#081B4B] md:text-[50px]">
            Local SEO Packages for Florida Law Firms
          </h2>

          <p className="mx-auto mt-4 max-w-[960px] text-[15px] leading-7 text-black/60 md:text-[18px]">
            We bring you flexible local SEO plans tailored to your solo or
            multi-location law firm across FL, your practice areas, your
            competitive market and your growth goals.
          </p>
        </div>
        ...
        <p className="mx-auto mt-4 max-w-[980px] text-center text-[13px] leading-6 text-black/55">
          All packages are adjusted based on your Florida practice area,
          competitive environment, and growth objectives. Contact Bayshore
          Communication for a proposal built specifically around your law
          firm&apos;s needs.
        </p>
      </div>
    </section>
