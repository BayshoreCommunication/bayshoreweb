        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1fr_430px] xl:gap-24">
          ...
          <div>
            ...
            <p className="mt-6 max-w-[700px] text-[16px] leading-[1.7] text-white/85 md:text-[18px]">
              Spring Hill, Florida, is one of the fastest-growing communities in Hernando County.
              The demand for local products as well as services grows with every new household.
              Bayshore Communication is the faithful SEO company Spring Hill that local businesses
              rely on to capture that demand. We design search strategies that place your business
              at the top of Google at the exact moment your ideal customer is ready to act.
            </p>
