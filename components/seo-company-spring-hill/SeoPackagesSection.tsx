...
const packageColumns: PackageColumn[] = [
  {
    key: "launch",
    title: "Starter Plan",
    subtitle: "New businesses building their first local search presence",
    price: "$1,500",
  ...
  },
  {
    key: "scale",
    title: "Growth Plan",
    subtitle: "Growing businesses ready to dominate Spring Hill Florida search",
    price: "$3,500",
  ...
  },
  {
    ...
    subtitle: "Established businesses seeking market-leading authority",
    price: "$7,000",
    cta: "Request Proposal",
  },
];
      ...
      <div className="mx-auto max-w-[1500px] px-4 md:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-[960px] text-[15px] leading-7 text-black/60 md:text-[18px]">
            Bayshore Communication offers structured SEO plans designed to meet Spring Hill Florida businesses at every stage of their growth. All packages are built around your specific service categories and adjusted as your business and market evolve.
          </p>
        </div>
        ...
        <p className="mx-auto mt-4 max-w-[980px] text-center text-[13px] leading-6 text-black/55">
          All packages are adjusted based on your Spring Hill industry,
