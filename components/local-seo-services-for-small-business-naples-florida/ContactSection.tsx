        ...
        <div className="grid gap-10 lg:grid-cols-[480px_minmax(0,1fr)] lg:gap-16 xl:gap-20">
          ...
          <div className="pt-2 md:pt-12">
            ...
            <p className="mt-8 max-w-[440px] text-[17px] leading-8 text-black/70 md:text-[19px]">
              Start building a stronger local search presence in Naples, Florida,
              that brings more customers directly to your small business.
            </p>
            ...
            <div className="mt-12 space-y-5">
              {[
                {
                  icon: TrendingUp,
                  text: "Local SEO Strategies Built for Naples Small Businesses",
                },
                {
                  icon: MapPin,
                  text: "More Visibility. More Traffic. More Naples Customers.",
                },
                {
                  icon: Users,
                  text: "A Team That Understands the Naples Florida Market",
                },
                {
                  icon: ShieldCheck,
          ...
          <div className="self-start">
            ...
            <div className="grid gap-5 rounded-b-[16px] border border-t-0 border-black/5 bg-white px-6 py-5 shadow-[0_18px_35px_rgba(0,0,0,0.07)] md:grid-cols-3 md:px-8">
              <TrustItem
                ...
                text="Trusted by Small Businesses Across Southwest Florida"
              />

              <TrustItem
                icon={<Star size={22} />}
                text="Proven Strategies. Real Naples Results."
              />

              <TrustItem
                icon={<MapPin size={22} />}
                text="Focused on Naples Florida and Surrounding Areas"
              />
            </div>
          </div>
        </div>
