...
const features = [
  {
    Icon: Award,
    title: "Naples Market Knowledge",
    description:
      "We understand seasonal customer patterns, affluent demographics, competitive dynamics and industry landscape of Collier County and the greater Naples area.",
  },
  {
    Icon: TrendingUp,
    title: "Proven Measurable Results",
    description:
      "Every campaign is tracked against clearly defined KPIs. You always know exactly what your local SEO investment is delivering in terms of leads, rankings and revenue.",
  },
  {
    Icon: SearchCheck,
    title: "No Long-Term Lock-In Contracts",
    description:
      "We earn your business every single month. Our results speak for themselves and we do not need a lengthy contract to keep your trust.",
  },
  {
    Icon: MapPinned,
    title: "White-Hat Only Methods",
    description:
      "We use only ethical, Google approved SEO practices to protect your Naples business reputation and maintain your rankings for the long term.",
  },
  {
    Icon: Layers3,
    title: "Responsive and Direct Communication",
    description:
      "You get direct access to your dedicated SEO team. Questions are answered quickly and your strategy is adjusted based on real performance data and your feedback.",
  },
  {
    Icon: ClipboardList,
    title: "Small Business Local SEO Specialist",
    description:
      "We focus exclusively on local small businesses, not enterprise accounts. Your Naples business campaign receives the same focused attention as our most established clients.",
  },
];
        ...
        <div className="grid gap-10 lg:grid-cols-[520px_1fr] lg:items-center">
          ...
          <div>
            <span className="text-xl font-bold uppercase tracking-wider text-[#FF6F00]">
              Why Naples Florida Small Businesses
            </span>
            ...
            <div className="mt-8 space-y-6 text-[15px] leading-8 text-black/75 md:text-[18px]">
              <p>
                Every Naples business owner trusts Bayshore Communication because
                we deliver measurable results. Our specialized local SEO services
                for small business Naples Florida come with proven strategies for
