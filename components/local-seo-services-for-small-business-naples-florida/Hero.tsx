        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1fr_430px] xl:gap-24">
          ...
          <div>
            ...
            <h1 className="mt-6 max-w-[720px] text-[38px] font-extrabold leading-[1.05] sm:text-[52px] md:text-[64px]">
              ...
              in Naples Florida
              <br />
              <span className="text-[#FF6F00]">More Visibility.</span>
              <br />
              More Customers.
              <br />
              More Growth.
            ...
            <p className="mt-6 max-w-[700px] text-[16px] leading-[1.7] text-white/85 md:text-[18px]">
              Bayshore Communication offers local SEO services for small business
              Naples Florida to connect with active search customers. We are a
              trusted local SEO partner for small businesses in Naples Florida to
              rank top in Google and AI search result. Our proven strategy brings
              more qualified leads and long term growth.
            </p>
