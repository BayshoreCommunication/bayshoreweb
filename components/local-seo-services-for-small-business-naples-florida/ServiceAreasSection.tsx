...
const businessTypes = [
  ...
  },
  {
    ...
    items: [
      "Personal Injury and Property Damage Attorneys",
      "Family Law, Immigration and Other Legal Practices",
    ],
  },
  {
    icon: Scale,
  ...
  {
    icon: Dumbbell,
    title: "Retail & Digital Businesses",
    items: [
      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="mx-auto max-w-[1100px] text-center">
          <h2 className="text-[38px] font-bold leading-[1.1] text-black md:text-[52px]">
            Serving Small Businesses Across{" "}
          ...
          <p className="mx-auto mt-8 max-w-[1000px] text-[16px] leading-8 text-black/70 md:text-[20px]">
            Bayshore Communication serves small businesses throughout Naples,
            Florida, and the wider Collier County and Southwest Florida region.
