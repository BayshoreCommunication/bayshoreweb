...
//     html2canvas(input, { scale: 3, backgroundColor: '#ffffff' }).then(
//       (canvas) => {
...
//   const initialPricingList: PricingItem[] = [
//     {
//       servicesName: 'Website Maintains',
//       serviceDetails: [
//         { services: 'Maintains, Cybersecurity, Hosting, SSL' },
...
//         <div
//           id='table-container'
//           className='relative overflow-auto shadow-md md:rounded-lg '
//         >
...
//               width={300}
//               height={150}
//               className='w-[200px] md:w-[300px] h-auto py-10'
//               priority
//             />
//             <h2 className='mb-8 !text-[24px] !font-bold text-center'>
//               Your Growth Plan
//             </h2>
//           </div>
...
//                   Quantity
//                 </th>
//                 <th scope='col' className='px-0 py-10'>
//                   Estimated Total Price
//                 </th>
//               </tr>
//             </thead>
//             <tbody>
//               {pricingList?.map((el: any, serviceIndex: number) => (
//                 <tr
//                   key={serviceIndex}
...
//                       <ul className='max-w-xl space-y-4 list-none list-inside '>
//                         {el?.unitPrice?.map(
//                           (service: any, detailIndex: number) => (
//                             <div key={detailIndex}>
//                               <li
//                                 className={`${
//                                   service?.price !== null
...
//                                   type='number'
//                                   value={
//                                     service?.price[detailIndex]?.price ?? ''
//                                   }
//                                   onChange={(e) =>
//                                     handleInputChange(
//                                       serviceIndex,
...
//                                   type='number'
//                                   value={
//                                     service?.quantity[detailIndex]?.quantitys ??
//                                     ''
//                                   }
//                                   onChange={(e) =>
//                                     handleInputChange(
...
//                                 }`}
//                               >
//                                 {service.estimatedTotalPrice[detailIndex]
//                                   .totalPrice !== null
//                                   ? service.estimatedTotalPrice[detailIndex]
//                                       .totalPrice
//                                   : 'N/A'}
...
const ServicePricingPlanCustomized = () => {
  return <div>ServicePricingPlanCustomized</div>;
};
