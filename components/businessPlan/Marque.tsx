...
export default function TrustedBy() {
  ...
  return (
    <div className="w-full bg-white py-32 text-center">
      ...
      <div className="transform -rotate-[7deg] scale-100 translate-y-1/2 relative">
        <Marquee speed={60} gradient={true} gradientColor="white" gradientWidth={100} className="w-screen">
          <div className="flex space-x-10 text-white bg-[#1b1b1b] py-16 text-[14px] md:text-xl font-medium uppercase tracking-wide w-full">
      ...
      <div className="transform rotate-[7deg] scale-100 mt-6 translate-y-2/5 relative">
        <Marquee speed={50} gradient={true} gradientColor="white" gradientWidth={100} direction="right" className="w-screen">
          <div className="flex items-center space-x-16 bg-orange-500 py-8 w-full">
            {[...logos, ...logos].map((src, i) => (
              <Image key={i} src={src} alt={`Logo ${i + 1}`} width={500} height={340} className="w-[60px] h-auto" />
            ))}
          </div>
        </Marquee>
        {/* Custom blur overlay for enhanced effect */}
