...
const testimonials = [
  {
    ...
    icon: Scale,
    review:
      "Prior to Bayshore Communication, our website did not receive much organic traffic. In just 6 months we were number 1 on a number of high value keywords. Consultation requests from organic search increased more than 60%. The team understands the legal market and delivers on every commitment.",
  },
  {
    image:
    ...
    icon: Scale,
    review:
      "I had tried SEO with another agency without results. Bayshore Communication was different. They audited our site thoroughly and explained what to change. Visible results arrived in the first quarter. Our Google Business Profile now appears in the map pack and lead quality has improved.",
  },
  {
    image:
    ...
    icon: Scale,
    review:
      "Criminal defense is intensely competitive in Lee County. Bayshore Communication built a content and link program that moved us from page three. Within twelve months we ranked at the top of page one for three priority keywords. The ROI has been substantial and our paid advertising spend has decreased.",
  },
];
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <h2 className="mt-6 text-[38px] font-bold leading-[1.1] text-black md:text-[52px]">
              What Our Fort Myers Law
              <br />
              Firm <span className="text-[#FF6F00]">Clients Are Saying</span>
            </h2>
          </div>

          <div className="lg:pl-20">
            <p className="max-w-[560px] text-[18px] leading-9 text-black/70">
              Our record is built on client outcomes, not on claims. See what
              Fort Myers law firm clients have to say about working with
