        ...
        <div className="grid gap-10 lg:grid-cols-[480px_minmax(0,1fr)] lg:gap-16 xl:gap-20">
          ...
          <div className="pt-2 md:pt-12">
            ...
            <p className="mt-8 max-w-[440px] text-[17px] leading-8 text-black/70 md:text-[19px]">
              The clients you want are already searching online. Let&apos;s make
              sure your firm is the one they find first.
            </p>
            ...
            <div className="mt-12 space-y-5">
              {[
                {
                  icon: TrendingUp,
                  text: "Local SEO Strategies That Drive Results for Law Firms",
                },
                {
                  icon: MapPin,
                  text: "More Visibility. More Clients. More Cases.",
                },
                {
                  icon: Users,
                  text: "A Team That Understands Fort Myers Legal Markets",
                },
                {
                  icon: ShieldCheck,
          ...
          <div className="self-start">
            ...
            <div className="grid gap-5 rounded-b-[16px] border border-t-0 border-black/5 bg-white px-6 py-5 shadow-[0_18px_35px_rgba(0,0,0,0.07)] md:grid-cols-3 md:px-8">
              <TrustItem
                ...
                text="Trusted by Law Firms Across Lee County"
              />
              ...
              <TrustItem
                icon={<MapPin size={22} />}
                text="Focused on Fort Myers and Surrounding Areas"
              />
            </div>
          </div>
        </div>
