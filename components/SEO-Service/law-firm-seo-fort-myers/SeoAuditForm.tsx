      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[1fr_420px] lg:gap-24">
          <div>
            ...
            >
              Get Your Free{" "}
              <span className="text-[#FF6F00]">Fort Myers Law Firm</span> SEO
              Audit Report
            </h2>
          </div>
          ...
          <div>
            <p className="max-w-[420px] text-[16px] leading-8 text-black/80 md:text-[18px] font-bold">
              Every search result tells a story about who gets the next client.
              Our free Fort Myers law firm SEO audit shows where your firm
              stands today and where the biggest growth opportunities exist.
            </p>
          </div>
        </div>
        ...
        >
          {success ? (
            ...
            <input
              type="hidden"
              name="service"
              value="Fort Myers Law Firm SEO Audit"
            />
