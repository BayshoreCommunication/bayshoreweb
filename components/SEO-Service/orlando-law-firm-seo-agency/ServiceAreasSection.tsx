...
const businessTypes = [
  {
    ...
    items: [
      ...
      "Tax Professionals and Accountants (CPA firms)",
...
export default function ServiceAreasSection() {
  const currentPath = "/orlando-law-firm-seo-agency";
      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="mx-auto max-w-[1100px] text-center">
          ...
          <p className="mx-auto mt-8 max-w-[1000px] text-[16px] leading-8 text-black/70 md:text-[20px]">
            Bayshore Communication serves law firms and businesses across Tampa Bay and provides statewide Florida coverage. Our strategies are built around the communities where your customers live and search.
          </p>
        </div>
