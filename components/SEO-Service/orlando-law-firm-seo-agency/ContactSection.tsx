      ...
      <div className="relative mx-auto max-w-[1420px] px-5 md:px-8">
        <div className="grid gap-10 lg:grid-cols-[480px_minmax(0,1fr)] lg:gap-16 xl:gap-20">
          ...
          <div className="pt-2 md:pt-12">
            ...
            <p className="mt-8 max-w-[440px] text-[15px] leading-relaxed text-black/70 md:text-[16px]">
              Bayshore Communication builds SEO programs specifically for Orlando law firms in competitive local markets. We start with a free audit to show you about your site&apos;s ranking and traffic issue. Reach out today and let&apos;s build effective SEO plan for your firm&apos;s Google and AI search visibility.
            </p>
            ...
            <div className="mt-12 space-y-5">
              {[
                {
                  icon: TrendingUp,
                  text: "Law Firm SEO Strategies That Drive Results",
                },
                {
                  icon: MapPin,
                  text: "More Visibility. More Traffic. More Clients.",
                },
                {
                  icon: Users,
                  text: "A Local Team That Understands Orlando's Legal Market",
                },
                {
                  icon: ShieldCheck,
          ...
          <div className="self-start">
            ...
            <div className="grid gap-5 rounded-b-[16px] border border-t-0 border-black/5 bg-white px-6 py-5 shadow-[0_18px_35px_rgba(0,0,0,0.07)] md:grid-cols-3 md:px-8">
              <TrustItem
                ...
                text="Trusted by Law Firms Across Orange County"
              />
              ...
              <TrustItem
                icon={<MapPin size={22} />}
                text="Focused on Orlando and Surrounding Areas"
              />
            </div>
          </div>
        </div>
