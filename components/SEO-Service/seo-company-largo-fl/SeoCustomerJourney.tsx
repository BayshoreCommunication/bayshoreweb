      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="mx-auto max-w-[900px] text-center">
          <h2 className="text-[32px] font-bold leading-[1.1] text-[#081B4B] md:text-[48px]">
            How SEO Turns <span className="text-[#FF6F00]">Largo</span>,
          ...
          <p className="mx-auto mt-6 max-w-[900px] text-[15px] leading-7 text-black/70 md:text-[18px] md:leading-8">
            ...
            which Largo business will earn that call or visit. The right
            SEO company Largo positions your business as the first answer
