      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[1fr_420px] lg:gap-24">
          <div>
            ...
            >
              Get Your Free{" "}
              <span className="text-[#FF6F00]">Florida Law Firm</span> Local SEO
              Audit Report
            </h2>
          </div>
          ...
          <div>
            <p className="max-w-[420px] text-[16px] leading-8 text-black/80 md:text-[18px] font-bold">
              Get Your Free SEO Audit for High-Value Florida Legal Leads!
              Experience Real Florida Search Results.
            </p>
          </div>
        </div>
        ...
        >
          {success ? (
            ...
            <input
              type="hidden"
              name="service"
              value="Florida Law Firm Local SEO Audit"
            />
