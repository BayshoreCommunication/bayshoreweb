    ...
    <section className="relative isolate overflow-hidden bg-[#020B2D] text-white">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Local SEO for Lawyers Florida"
          fill
          priority
        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1fr_430px] xl:gap-24">
          ...
          <div>
            ...
            <h1 className="mt-6 max-w-[720px] text-[38px] font-extrabold leading-[1.05] sm:text-[52px] md:text-[64px]">
              ...
              <br />
              Get More Clients,{" "}
              <span className="text-[#FF6F00]">Win More</span>
              <br />
              Cases
            </h1>

            <p className="mt-6 max-w-[700px] text-[16px] leading-[1.7] text-white/85 md:text-[18px]">
              Transform your lead generation growth exponentially through
              Bayshore Communication&apos;s specialized local SEO for lawyers
              Florida. We rank legal professionals high in regional search
              results through custom, data-driven SEO strategies. We designed
              our plans with a clear understanding of user search behavior and
              competitive pressure. We optimize your AI &amp; google visibility,
              maximize ROI using advanced analytics, AI-driven strategies and
              constant dedication.
            </p>
