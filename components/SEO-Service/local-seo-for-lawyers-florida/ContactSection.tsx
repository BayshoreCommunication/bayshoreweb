        ...
        <div className="grid gap-10 lg:grid-cols-[480px_minmax(0,1fr)] lg:gap-16 xl:gap-20">
          ...
          <div className="pt-2 md:pt-12">
            ...
            <p className="mt-8 max-w-[440px] text-[17px] leading-8 text-black/70 md:text-[19px]">
              If you&apos;re ready for higher traffic and conversion for your law
              firm, contact us today. Let our SEO experts enhance your
              visibility and grow your practice.
            </p>
            ...
            <div className="mt-12 space-y-5">
              {[
                {
                  icon: TrendingUp,
                  text: "Local SEO Strategies That Drive Legal Leads",
                },
                {
                  icon: MapPin,
                  text: "Map Pack Visibility Across Florida Cities",
                },
                {
                  icon: Users,
                  text: "Specialists in Legal SEO for Florida Attorneys",
                },
                {
                  icon: ShieldCheck,
          ...
          <div className="self-start">
            ...
            <div className="grid gap-5 rounded-b-[16px] border border-t-0 border-black/5 bg-white px-6 py-5 shadow-[0_18px_35px_rgba(0,0,0,0.07)] md:grid-cols-3 md:px-8">
              <TrustItem
                ...
                text="Trusted by Florida Law Firms Statewide"
              />

              <TrustItem
                icon={<Star size={22} />}
                text="Proven Legal SEO. Real Case Results."
              />

              <TrustItem
                icon={<MapPin size={22} />}
                text="Serving Law Firms Across All of Florida"
              />
            </div>
          </div>
        </div>
