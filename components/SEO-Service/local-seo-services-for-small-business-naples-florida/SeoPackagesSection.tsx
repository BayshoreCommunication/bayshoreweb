      ...
      <div className="mx-auto max-w-[1500px] px-4 md:px-8">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-4 max-w-[1180px] text-[32px] font-bold leading-[1.08] text-[#081B4B] md:text-[50px]">
            Affordable Local SEO Packages for Naples Florida Small Businesses
          </h2>

          <p className="mx-auto mt-4 max-w-[960px] text-[15px] leading-7 text-black/60 md:text-[18px]">
            Choose the right local SEO package for your Naples Florida small
            business budget and growth goals. Bayshore Communication offers
            flexible options at every growth stage.
          </p>
        </div>
        ...
        <p className="mx-auto mt-4 max-w-[980px] text-center text-[13px] leading-6 text-black/55">
          All packages are adjusted based on your Naples Florida industry,
          competitive environment, and growth objectives. Contact Bayshore
          Communication for a proposal built specifically around your Naples
          Florida small business needs.
        </p>
      </div>
    </section>
  );
