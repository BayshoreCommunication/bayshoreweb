        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1fr_430px] xl:gap-24">
          ...
          <div>
            ...
            <h1 className="mt-6 max-w-[720px] text-[38px] font-extrabold leading-[1.05] sm:text-[52px] md:text-[64px]">
              SEO Company in
              <br />
              <span className="text-[#FF6F00]">Plant City</span>
              <br />
              For Florida Business
            </h1>

            <p className="mt-4 text-[18px] md:text-[22px] font-bold text-[#FF6F00] leading-snug">
              More Traffic, More Customers, More Growth
            </p>

            <p className="mt-6 max-w-[700px] text-[16px] leading-[1.7] text-white/85 md:text-[18px]">
              Every single hour your target clients search for specific services on Google and first to appear gets the call. Bayshore Communication is the leading Plant City SEO company and makes sure your business shows up for those exact queries on page 1. We build authoritative search visibility for Florida businesses across every major industry. We are a reliable, results driven Plant City SEO company with a deep understanding of your local market, your competitors and exact techniques required to convert viewers into paying buyers.
            </p>
