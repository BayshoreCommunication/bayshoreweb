...
const aiSearchCards = [
  {
    Icon: FileCheck2,
    title: "AI Overviews pull answers from authoritative local content",
    description:
      "Websites with clearly organized service pages get cited in AI answers and appear above standard organic results.",
  },
  {
    Icon: AudioLines,
    title: "Conversational queries demand different keyword targeting",
    description:
      "Someone asking an AI assistant queries with specific terms needs businesses with clear and trustworthy answered content.",
  },
  {
    Icon: Cpu,
    title: "Entity authority determines business's reliability",
    description:
      "AI systems recognize industry with consistent business data, verified profiles and brand mentions across quality websites.",
  },
  {
    Icon: Trophy,
    title: "Zero click results still drive real brand recognition",
    description:
      "Businesses earn featured snippet positions on results pages for high intent local queries from potential clients.",
  },
  {
    Icon: MessageSquareText,
    title: "Structured data tells AI tools about business details",
    description:
      "Schema markup on sites ensures AI search tools display accurate hours, services, and contact details.",
  },
];
      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="mx-auto max-w-[900px] text-left md:text-center">
          <h2 className="text-[32px] font-bold leading-[1.15] text-[#081B4B] md:text-[42px]">
            ...
            <span className="text-[#FF6F00]">Plant City</span> Florida
            Businesses in 2026
          </h2>
          <p className="mt-6 text-[16px] leading-8 text-[#081B4B]/70 md:text-[18px]">
            Google&apos;s AI Overviews changed structure of search results. Content strategies built in previous years are producing half results they once did.
          </p>
        </div>
