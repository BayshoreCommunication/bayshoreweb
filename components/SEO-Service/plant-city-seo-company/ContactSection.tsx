      ...
      <div className="relative mx-auto max-w-[1420px] px-5 md:px-8">
        <div className="grid gap-10 lg:grid-cols-[480px_minmax(0,1fr)] lg:gap-16 xl:gap-20">
          ...
          <div className="pt-2 md:pt-12">
            ...
            <p className="mt-8 max-w-[440px] text-[16px] leading-7 text-black/70">
              Bayshore Communication is ready to build search strategy around your specific industry, competitive environment and growth goals in Plant City. Reach out today for your free audit and find out exactly where your Plant City rankings stand.
            </p>
            ...
            <div className="mt-12 space-y-5">
              {[
                ...
                {
                  icon: Users,
                  text: "A Local Team That Understands Plant City",
                },
                {
                  icon: ShieldCheck,
          ...
          <div className="self-start">
            ...
            <div className="grid gap-5 rounded-b-[16px] border border-t-0 border-black/5 bg-white px-6 py-5 shadow-[0_18px_35px_rgba(0,0,0,0.07)] md:grid-cols-3 md:px-8">
              ...
              <TrustItem
                icon={<MapPin size={22} />}
                text="Focused on Plant City and Surrounding Areas"
              />
            </div>
          </div>
        </div>
