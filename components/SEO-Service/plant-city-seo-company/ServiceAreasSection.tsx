...
const businessTypes = [
  ...
  },
  {
    ...
    items: [
      ...
      "Accountants & Tax Professionals (CPA)",
...
export default function ServiceAreasSection() {
  const currentPath = "/plant-city-seo-company";
      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="mx-auto max-w-[1100px] text-center">
          ...
          <p className="mx-auto mt-8 max-w-[1000px] text-[16px] leading-8 text-black/70 md:text-[20px]">
            Bayshore Communication serves businesses throughout Plant City,
            Florida, and the wider Hillsborough County and Tampa Bay region.
        ...
        <div className="mt-12 grid gap-8 lg:mt-20 lg:grid-cols-[1.7fr_1fr]">
          ...
          {/* Bottom Card for Statewide Florida Coverage */}
          <div
            className="
              lg:col-span-3
              rounded-[28px]
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {floridaCities.map((city, index) => (
                <span
                  key={getSeoLocationName(city, index)}
                  className="
                    rounded-full
                    border
                    border-black/10
                  ...
                  "
                >
                  {getSeoLocationName(city, index)}</span>
              ))}
            </div>
          </div>
        </div>
