...
const features = [
  {
    Icon: Award,
    title: "Industry Specific SEO Knowledge",
    description:
      "We build distinct strategies for each vertical rather than running one framework across every client account.",
  },
  {
    Icon: Handshake,
    title: "No Long Term Lock In Contracts",
    description:
      "Month to month arrangements are available because we want our clients to see improvements.",
  },
  {
    Icon: Eye,
    title: "Full Transparency on Every Month Deliverable",
    description:
      "We allow our clients to know every deliverable, process, tool and tracked metric every month.",
  },
  {
    Icon: TrendingUp,
    title: "Strategy Built on Search and Competitive Data",
    description:
      "Keyword research, competitor ranking analysis and local search volume data specific to Plant City and Hillsborough County drive every recommendation.",
  },
  {
    Icon: Users,
    title: "Direct Access to Strategists",
    description:
      "Plant City clients communicate directly with team managing their campaign. Decisions get made faster and problems get resolved in hours rather than days.",
  },
  {
    Icon: Target,
    title: "Content Matched to Buyer Intent",
    description:
      "Our writers produce content based on Plant City’s clients’ high intent searches.",
  },
  {
    Icon: RefreshCw,
    title: "Documented Recovery Process",
    description:
      "When Google updates cost client rankings, we diagnose the cause and execute recovery with structured, documented process.",
  },
];
        ...
        <div className="grid gap-10 lg:grid-cols-[520px_1fr] lg:items-center">
          ...
          <div>
            <span className="text-xl font-bold uppercase tracking-wider text-[#FF6F00]">
              Why Plant City Florida Businesses
            </span>
            ...
            <div className="mt-8 space-y-6 text-[15px] leading-8 text-black/75 md:text-[18px]">
              <p>
                Choosing an SEO company Plant City comes down to one question.
