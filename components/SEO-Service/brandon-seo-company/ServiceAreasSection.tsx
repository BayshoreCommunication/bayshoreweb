            ...
            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
              {communities.map((community, index) => (
                <Link key={getSeoLocationName(community, index)} href={getInternalRoute(community)} className="
                  ...
                  <span className="font-medium text-[#081B4B] text-[15px]">{getSeoLocationName(community, index)}</span>
                </Link>
              ))}
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-x-6 gap-y-3 text-[14px] font-semibold text-[#081B4B]/70 md:text-[16px]">
            {[
              ...
              <span key={city} className="flex items-center gap-3">
                <Link href={getInternalRoute(city)} className="hover:text-[#FF6F00] transition-colors">{getSeoLocationName(city, index)}</Link>
                {index < arr.length - 1 && (
