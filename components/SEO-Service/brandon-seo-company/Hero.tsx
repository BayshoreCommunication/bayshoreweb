        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1fr_430px] xl:gap-24">
          ...
          <div>
            ...
            <p className="mt-6 max-w-[700px] text-[16px] leading-[1.7] text-white/85 md:text-[18px]">
              Doesn&apos;t it cost you every time Brandon customers search for your service and call your competitor instead? Bayshore Communications, a Brandon SEO company builds search presence to put your business in front of buyers. Our strategy works across Google&apos;s organic results, local map pack, and AI generated answers.
            </p>
