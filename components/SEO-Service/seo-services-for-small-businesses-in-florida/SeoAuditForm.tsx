      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[1fr_420px] lg:gap-24">
          <div>
            ...
            >
              Get Your Free{" "}
              <span className="text-[#FF6F00]">Florida Small Business</span>{" "}
              SEO Audit Report
            </h2>
          </div>
          ...
          <div>
            <p className="max-w-[420px] text-[16px] leading-8 text-black/80 md:text-[18px] font-bold">
              Free SEO Audit For Real Florida Search Results. Get a full report
              of your business&apos;s SEO gaps within 48 hours.
            </p>
          </div>
        </div>
        ...
        >
          {success ? (
            ...
            <input
              type="hidden"
              name="service"
              value="Florida Small Business SEO Audit"
            />
            ...
            <div className="flex justify-center pt-2 md:pt-4">
              ...
              >
                ...
                <span className="relative z-10">
                  {loading ? "Submitting..." : "Get Your Free SEO Audit Report"}
                </span>
              </button>
            </div>
