...
type PackageKey = "starter" | "growth" | "authority";
...
const packageColumns: PackageColumn[] = [
  ...
  },
  {
    key: "authority",
    title: "Authority",
    subtitle: "Multi location & Competitive",
    price: "$$$$",
    cta: "Contact Us To Get Started",
  },
];
...
const featureRows: FeatureRow[] = [
  {
    ...
    values: {
      starter: ["Included", "Not Included", "Not Included"],
      growth: ["Included", "Included", "Included"],
      authority: ["Included", "Included", "Included"],
    },
  },
  {
    ...
    items: [
      ...
      "Full website on-page SEO (up to 15 pages)",
      "Unlimited page optimization",
      "Basic technical SEO audit & fixes",
      "Schema markup implementation",
    ],
    values: {
      starter: ["Included", "Not Included", "Not Included", "Included", "Not Included"],
      growth: ["Included", "Included", "Not Included", "Included", "Not Included"],
      authority: ["Included", "Included", "Included", "Included", "Included"],
    },
  },
  {
    ...
    items: [
      ...
      "4 SEO articles + content strategy",
      "Local link building (5 placements/mo)",
      "AI search (AEO) optimization",
    ],
    values: {
      starter: ["Not Included", "Not Included", "Not Included", "Not Included"],
      growth: ["Included", "Not Included", "Included", "Not Included"],
      authority: ["Included", "Included", "Included", "Included"],
    },
  },
  {
    ...
    values: {
      ...
      growth: ["Not Included", "Not Included", "Not Included"],
      authority: ["Included", "Included", "Included"],
    },
  },
  {
    ...
    values: {
      starter: ["Included", "Included", "Not Included"],
      growth: ["Included", "Included", "Included"],
      authority: ["Included", "Included", "Included"],
    },
  },
  {
    ...
    values: {
      ...
      growth: ["Included", "Not Included"],
      authority: ["Included", "Included"],
    },
  },
];
      ...
      <div className="mx-auto max-w-[1500px] px-4 md:px-8">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-4 max-w-[1180px] text-[32px] font-bold leading-[1.08] text-[#081B4B] md:text-[50px]">
            Cost Effective SEO Packages for Florida Small Businesses
          </h2>

          <p className="mx-auto mt-4 max-w-[960px] text-[15px] leading-7 text-black/60 md:text-[18px]">
            We offer transparent, results-focused SEO packages built
            specifically for Florida small businesses.
          </p>
        </div>
        ...
        <p className="mx-auto mt-4 max-w-[980px] text-center text-[13px] leading-6 text-black/55">
          Contact Bayshore Communication for a proposal built specifically
