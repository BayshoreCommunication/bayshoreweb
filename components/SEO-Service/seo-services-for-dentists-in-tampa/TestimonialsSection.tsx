...
const testimonials = [
  {
    ...
    icon: Stethoscope,
    review:
      "Bayshore Communication transformed our online visibility within just a few months of starting. We now consistently book new patients directly from Google every single week.",
  },
  {
    image:
    ...
    icon: Stethoscope,
    review:
      "We had a well-designed website that no one could actually find online. Bayshore resolved that completely. Our phone rings more consistently than it ever has before.",
  },
  {
    image:
    ...
    icon: Stethoscope,
    review:
      "The team is deeply knowledgeable, fully transparent, and genuinely invested in our practice growth. I recommend Bayshore Communication to every dental colleague in Tampa without hesitation.",
  },
];
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-end">
          <div>
            ...
            <h2 className="mt-6 text-[38px] font-bold leading-[1.1] text-black md:text-[52px]">
              What Our Tampa Dental
              <br />
              <span className="text-[#FF6F00]">Practice Clients Are Saying</span>
            </h2>
          </div>

          <div className="lg:pl-20">
            <p className="max-w-[560px] text-[18px] leading-9 text-black/70">
              We&apos;re proud to help Tampa dental practices grow their visibility, attract more patients, and achieve
              lasting results.
            </p>
