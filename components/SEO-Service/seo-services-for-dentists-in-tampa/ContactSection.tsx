        ...
        <div className="grid gap-10 lg:grid-cols-[480px_minmax(0,1fr)] lg:gap-16 xl:gap-20">
          ...
          <div className="pt-2 md:pt-12">
            ...
            <p className="mt-8 max-w-[440px] text-[17px] leading-8 text-black/70 md:text-[19px]">
              Your Next Patient Is One Search Away. Make Sure They Find You Before a Competitor Does.
            </p>
            ...
            <div className="mt-12 space-y-5">
              {[
                {
                  icon: TrendingUp,
                  text: "Local SEO Strategies That Drive Patient Growth",
                },
                {
                  icon: MapPin,
                  text: "More Visibility. More Patients. More Appointments.",
                },
                {
                  icon: Users,
                  text: "A Team That Understands Tampa Dental SEO",
                },
                {
                  icon: ShieldCheck,
          ...
          <div className="self-start">
            ...
            <div className="grid gap-5 rounded-b-[16px] border border-t-0 border-black/5 bg-white px-6 py-5 shadow-[0_18px_35px_rgba(0,0,0,0.07)] md:grid-cols-3 md:px-8">
              <TrustItem
                ...
                text="Trusted by Dental Practices Across Tampa Bay"
              />

              <TrustItem
                icon={<Star size={22} />}
                text="Proven Strategies. Real Patient Results."
              />
