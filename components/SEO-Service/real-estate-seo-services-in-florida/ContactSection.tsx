        ...
        <div className="grid gap-10 lg:grid-cols-[480px_minmax(0,1fr)] lg:gap-16 xl:gap-20">
          ...
          <div className="pt-2 md:pt-12">
            ...
            <p className="mt-8 max-w-[440px] text-[17px] leading-8 text-black/70 md:text-[19px]">
              Florida buyers and sellers are searching right now, and every day
              your site isn&apos;t ranking is a day a competitor is picking up
              that lead. Bayshore Communication&apos;s real estate SEO services
              in Florida are ready to move the moment you are. You&apos;re an
              independent agent in Orlando? Or a luxury brokerage in Miami? Or a
              commercial developer in Tampa? We build the search strategy that
              fits your market, your budget, and the deals you&apos;re actually
              trying to close.
            </p>
            ...
            <div className="mt-12 space-y-5">
              {[
                {
                  icon: TrendingUp,
                  text: "Florida buyers and sellers are searching right now",
                },
                {
                  icon: MapPin,
                  text: "Every day your site isn't ranking is a day a competitor is picking up that lead",
                },
                {
                  icon: Users,
                  text: "We build the search strategy that fits your market",
                },
                {
                  icon: ShieldCheck,
                  text: "Your budget, and the deals you're actually trying to close",
                },
              ].map((item, index) => {
          ...
          <div className="self-start">
            ...
            <div className="grid gap-5 rounded-b-[16px] border border-t-0 border-black/5 bg-white px-6 py-5 shadow-[0_18px_35px_rgba(0,0,0,0.07)] md:grid-cols-3 md:px-8">
              ...
              text="Trusted by Florida Real Estate Businesses"
              />
              ...
              <TrustItem
                icon={<MapPin size={22} />}
              text="Focused on Florida and Statewide Real Estate Markets"
              />
            </div>
          </div>
        </div>
