...
const benefits = [
  {
    ...
    description:
      "Get a comprehensive review of your website SEO performance and key ranking factors specific to Largo.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Receive a clear, prioritized roadmap with actionable SEO recommendations to improve your Largo rankings.",
  },
];
