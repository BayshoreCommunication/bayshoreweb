...
const businessTypes = [
  {
    icon: Home,
    title: "Dental Specialties We Serve",
    items: [
      "General Dentistry",
      "Cosmetic Dentistry",
      "Pediatric Dentistry",
      "Orthodontics and Invisalign Practices",
      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="mx-auto max-w-[1100px] text-center">
          ...
          <p className="mx-auto mt-8 max-w-[1000px] text-[16px] leading-8 text-black/70 md:text-[20px]">
            Bayshore Communication provides SEO Services for Dentists in Tampa across all dental specialty types and service areas.
          </p>
        </div>
