      ...
      <div className="mx-auto max-w-[1620px] px-8 md:px-8">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[1fr_420px] lg:gap-24">
          <div>
            ...
            >
              Get Your Free{" "}
              <span className="text-[#FF6F00]">Wesley Chapel Florida</span> SEO
              Audit Report
            </h2>
          </div>
          ...
          <div>
            <p className="max-w-[420px] text-[16px] leading-8 text-black/80 md:text-[18px] font-bold">
              Find out what is helping your Wesley Chapel rankings, what is
              holding them back, and where your next growth opportunity exists.
            </p>
          </div>
        </div>
