...
const teamMembers = [
  {
    ...
    image: "/image/bayshore-team/executive.png",
  },
  {
    name: "Chief Technology Officer",
    image: "/image/bayshore-team/technology.png",
  },
  { name: "Creative Director", image: "/image/bayshore-team/creative.png" },
  {
    name: "Digital Marketing Manager",
    image: "/image/bayshore-team/digital.png",
  },
  {
    name: "Head of Digital Marketing",
    image: "/image/bayshore-team/digital-head.png",
  },
  {
    name: "Client Relationship Executive",
    image: "/image/bayshore-team/client.png",
  },
...
export default function Team() {
  return (
    <div className="relative bg-[url('/image/bayshore-team/bg.png')] bg-cover bg-center">
      <div className="max-w-[1240px] mx-auto px-8 pb-16 text-center">
        {/* Header Image */}
        <motion.div
