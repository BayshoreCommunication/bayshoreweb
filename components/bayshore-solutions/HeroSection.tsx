            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-8 w-full max-w-xl pt-2">
              ...
              >
                <motion.div
                  ...
                  className={`w-16 h-16 sm:w-22 sm:h-22 rounded-full flex items-center justify-center mb-3 transition-all duration-300 shadow-lg group-hover:shadow-2xl relative ${
                    theme === "dark"
