                  ...
                  <div className="flex flex-col text-left">
                    <motion.div whileFocus={{ scale: 1.01 }}>
                      <input
                        ...
                        className={`w-full px-6 py-5 sm:px-7 sm:py-6 rounded-lg sm:rounded-2xl text-lg sm:text-xl lg:text-[18px] font-medium border transition-all outline-none focus:ring-2 ${
                          errors.fullName
