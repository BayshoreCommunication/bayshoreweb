      ...
      >
        {submitted ? (
          ...
          <div className="py-12 text-center flex flex-col items-center justify-center max-w-md mx-auto">
            ...
            <p
              className={`text-sm sm:text-base leading-relaxed font-medium mb-8 ${
          ...
          >
            ...
            <div className="mb-2">
              <h2
                ...
                className={`text-3xl sm:text-4xl lg:text-[40px] font-normal tracking-tight leading-tight mb-2.5 ${
                  theme === "dark" ? "text-white" : "text-[#0C1827]"
                }`}
              >
                {step === 1
                ...
                <div className="flex flex-col gap-2">
                  <label
                    ...
                    className={`text-[11px] font-extrabold uppercase tracking-[0.14em] ${
                      theme === "dark" ? "text-slate-300" : "text-[#3B4758]"
                    }`}
                  >
                    YOUR FULL NAME
                  </label>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <select
                      ...
                      } ${!formData.supportType ? "text-slate-500" : ""}`}
                    >
            ...
            {step === 2 && (
              <div className="flex flex-col gap-5 w-full">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 pt-3">
                  <button
                    ...
                    className={`w-full sm:w-auto px-6 py-4 rounded-full font-bold text-sm transition-all border ${
                      theme === "dark"
                        ...
                        : "border-slate-300 text-[#3B4758] hover:bg-slate-100 hover:text-[#0C1827]"
                    }`}
                  >
                  ...
                  <button
                    type="submit"
                    className={`w-full sm:flex-1 py-4 rounded-full font-extrabold text-base sm:text-lg transition-all duration-300 flex items-center justify-center gap-2 shadow-md transform active:scale-98 ${
                      theme === "dark"
                        ? "bg-[#FF5500] text-white hover:bg-[#e04a00]"
