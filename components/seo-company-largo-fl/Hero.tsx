        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1fr_430px] xl:gap-24">
          ...
          <div>
            ...
            <div className="mt-6 max-w-[700px] text-[16px] leading-[1.7] text-white/85 md:text-[18px] space-y-4">
              ...
              <p>
                We examine closely into the Largo market, study exactly how local buyers search, and build our strategy around those patterns. Our work does not chase numbers that look good on a report but mean nothing to your revenue. It drives qualified visitors who are already looking for what you offer and are ready to act on it.
              </p>
            </div>
