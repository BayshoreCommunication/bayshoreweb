...
const roiCards = [
  {
    icon: Target,
    title: "Intent-Driven Visitors",
    description:
      "Organic visitors arrive with demonstrated purchase intent rather than manufactured interest from ad targeting.",
  },
  {
    icon: ChartNoAxesCombined,
    title: "Growing Contact Volume",
    description:
      "Contact volume grows each month as more keywords rank and more search sessions end at your website.",
  },
  {
    icon: BadgeDollarSign,
    title: "Ad Budget Optimization",
    description:
      "Advertising budgets can be reallocated as organic search absorbs a growing share of total lead generation.",
  },
  {
    icon: ShieldCheck,
    title: "Domain Authority Growth",
    description:
      "Domain authority improvements make new page rankings faster and less resource-intensive to achieve.",
  },
  {
    icon: Handshake,
    title: "Lower Acquisition Costs",
    description:
      "Customer acquisition costs fall steadily as the organic channel matures and conversion rates strengthen.",
  },
  {
    icon: PiggyBank,
    title: "Defensive Competitive Edge",
    description:
      "Business credibility with search engines compounds and creates a growing defensive advantage against competitors.",
  },
];
